...
\section*{Code structure}
	\begin{frame}{Code structure}{Description of the project's files}	%RIVEDI!
		...
		Inspiration has been drawn from the formal definition of a graph 
...
\section*{Probabilities}
	\begin{frame}{Distributions of the nodes' random variables}
		...
		\begin{enumerate}
			...
			s.t. $p_{\hat{\imath}-1}\le r < p_{\hat{\imath}}$ $(p_0\coloneqq0)$
...
\section*{Comments and conclusion}
    \begin{frame}{Conclusion, and comments}
		...
		But it's complicated to model the relationship between the actual weather 
